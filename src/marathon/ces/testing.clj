...
(defn all-tests []
  ...
  (run-tests 'marathon.ces.testing.async))
...
;;Migrated integration tests to marathon.ces.testing.async since
;;they touch core.async and end up screwing us here a bit during
;;reload-all.
